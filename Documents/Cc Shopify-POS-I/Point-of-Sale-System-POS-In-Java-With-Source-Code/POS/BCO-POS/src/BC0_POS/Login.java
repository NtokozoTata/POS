...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_login.setBackground(new java.awt.Color(14, 18, 14));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_security_user_male_20px.png"))); // NOI18N
        ...
        jPanel2.add(panel_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 450));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Mainlogo4.png"))); // NOI18N
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 320, 270));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 10, 30, 30));

        jLabel6.setFont(new java.awt.Font("Perpetua Titling MT", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("CC - SHOPIFY");
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 310, 149, 45));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if (username.getText().isEmpty() && password.getText().isEmpty()){
            ...
            ResultSet rs = state.executeQuery("select username,password,username from login where username = '"+username.getText()+"' && password = '"+password.getText()+"'");
    ...
    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ...
        try{
           ...
           else{state.execute("insert into login (`username`,`password`,`log`) values ('"+user+"','"+pass+"','"+log+"')");
                panel_login.setVisible(true);
                panel_create.setVisible(false);
                } 
